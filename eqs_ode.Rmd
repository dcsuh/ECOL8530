...
for (i in 1:length(R0_list)){
  ...
  for (j in 0:100){
    ...
    herd$time[j+1] <- tmp$time[1]
  }
  final[[i]] <- herd
}

plot1 <- ggplot() + geom_line(data = final[[1]],aes(x=final[[1]]$phi, y=final[[1]]$time), color="red") +
  geom_line(data = final[[2]],aes(x=final[[2]]$phi, y=final[[2]]$time),color="green") +
  geom_line(data = final[[2]],aes(x=final[[3]]$phi, y=final[[3]]$time),color="blue") + 
  xlab("phi") + ylab("time")
...
plot2 <- ggplot() + geom_line(data = final[[1]],aes(x=final[[1]]$phi, y=final[[1]]$time), color="red") +
  geom_line(data = final[[2]],aes(x=final[[2]]$phi, y=final[[2]]$time),color="green") +
  geom_line(data = final[[2]],aes(x=final[[3]]$phi, y=final[[3]]$time),color="blue") + 
  xlab("phi") + ylab("time")
...
plot3 <- ggplot() + geom_line(data = final[[1]],aes(x=final[[1]]$phi, y=final[[1]]$time), color="red") +
  geom_line(data = final[[2]],aes(x=final[[2]]$phi, y=final[[2]]$time),color="green") +
  geom_line(data = final[[2]],aes(x=final[[3]]$phi, y=final[[3]]$time),color="blue") + 
  xlab("phi") + ylab("time")
